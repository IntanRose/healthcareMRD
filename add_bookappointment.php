...
<div class="container">
  ...
  <form action="" method="post" enctype="multipart/form-data">
    <div class="form-group">
      ...
      <input type="text" class="form-control" placeholder="Enter Doctor Full Name" name="doctorename">
    </div>
    <div class="form-group">
...
if (isset($_POST['insert-btn'])){
	...
	$insert = "INSERT INTO bookappointment (doctorid,appointmentdate,appointmenttime,status)
	VALUES ('$doctorid','$appointmentdate','$appointmenttime','$status')";
