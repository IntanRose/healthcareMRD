...
$query = "SELECT * FROM editprofile ORDER BY ID DESC";
			...
			<table id ="view_data" class ="table table-striped table-bordered">
				...
				while($row=mysqli_fetch_array($result))
				{
					...
					<tr>
						...
						<td><a class="btn btn-primary" href="edit_editprofile.php?edit='.$row["id"].'">Update</a></td> 
						<td><a class="btn btn-danger" href="editprofile_data.php?del='.$row["id"].'">Delete</a></td>
					</tr>
				';}
				?>
			</table>
			<a class="btn btn-success" href="add_editprofile.php">Add New Data</a>
...
if (isset($_GET['del'])){
	$del_id = $_GET['del'];
	$delete = "DELETE FROM editprofile WHERE id='$del_id'";
