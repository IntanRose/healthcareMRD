			...
			<table id ="view_data" class ="table table-striped table-bordered">
				...
				while($row=mysqli_fetch_array($result))
				{
					...
					<tr>
						...
						<td>'.$row["messages"].'</td>
						<td><a class="btn btn-primary" href="messages_data.php?edit='.$row["id"].'">Update</a></td> 
						<td><a class="btn btn-danger" href="messages_data.php?del='.$row["id"].'">Delete</a></td>
					</tr>
				';}
				?>
			</table>
			<a class="btn btn-success" href="editmessages.php">Add New Data</a>
...
if (isset($_GET['del'])){
	$del_id = $_GET['del'];
	$delete = "DELETE FROM messages WHERE id='$del_id'";
