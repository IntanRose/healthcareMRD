			...
			<table id ="view_data" class ="table table-striped table-bordered">
				...
				while($row=mysqli_fetch_array($result))
				{
					...
					<tr>
						...
						<td><a class="btn btn-primary" href="edit_patientinfo.php?edit='.$row["id"].'">Update</a></td> 
						<td><a class="btn btn-danger" href="patientinfo_data.php?del='.$row["id"].'">Delete</a></td>
					</tr>
				';}
				?>
			</table>
			<a class="btn btn-success" href="add_patientinfo.php">Add New Data</a>
...
if (isset($_GET['del'])){
	$del_id = $_GET['del'];
	$delete = "DELETE FROM patientinfo WHERE id='$del_id'";
