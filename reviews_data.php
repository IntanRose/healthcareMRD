			...
			<table id ="view_data" class ="table table-striped table-bordered">
				...
				while($row=mysqli_fetch_array($result))
				{
					...
					<tr>
						...
						<td>'.$row["rating"].'</td>
						<td>'.$row["comments"].'</td>
						<td><a class="btn btn-primary" href="edit_reviews.php?edit='.$row["id"].'">Update</a></td> 
						<td><a class="btn btn-danger" href="reviews_data.php?del='.$row["id"].'">Delete</a></td>
					</tr>
				';}
				?>
			</table>
			<a class="btn btn-success" href="add_reviews.php">Add New Data</a>
