			...
			<table id ="view_data" class ="table table-striped table-bordered">
				...
				while($row=mysqli_fetch_array($result))
				{
					...
					<tr>
						...
						<td><a class="btn btn-primary" href="add_schedule.php?edit='.$row["id"].'">Update</a></td> 
						<td><a class="btn btn-danger" href="schedule_data.php?del='.$row["id"].'">Delete</a></td>
					</tr>
				';}
				?>
			</table>
			<a class="btn btn-success" href="add_schedule.php">Add New Data</a>
...
if (isset($_GET['del'])){
	$del_id = $_GET['del'];
	$delete = "DELETE FROM schedule WHERE id='$del_id'";
